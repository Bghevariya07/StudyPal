<template>
    <nav class="mx-10 flex items-center justify-between p-4 bg-white w-full px-16">
        ...
        <div class="hidden md:flex space-x-7">
            ...
            <RouterLink to="/contact" class="pt-1 font-semibold hover:underline hover:text-primary active:text-primary">
                Contact</RouterLink>
                <RouterLink to="/chats" class="pt-1 font-semibold hover:underline hover:text-primary active:text-primary">
                    Chats</RouterLink>
            <RouterLink to="/login"
